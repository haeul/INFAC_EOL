    ...
    public partial class PNFCTouchFD : IDHSModel
    {
        ...
        private void TestStepTxProc(int channel)
        {
            switch (_currTestStep[channel])
            {
                ...
                case NFCTouchTestStep.WakeUpWait                  : NFCTouchTestStep_WakeUpWait                  (channel); break;
                case NFCTouchTestStep.ManufacturePrepareSend      : NFCTouchTestStep_ManufacturePrepareSend      (channel); break;
                case NFCTouchTestStep.ManufacturePrepareWait      : NFCTouchTestStep_ManufacturePrepareWait      (channel); break;
                case NFCTouchTestStep.ManufactureSeedkeySend      : NFCTouchTestStep_ManufactureSeedkeySend      (channel); break;
                case NFCTouchTestStep.ManufactureSeedkeyWait      : NFCTouchTestStep_ManufactureSeedkeyWait      (channel); break;
                ...
                case NFCTouchTestStep.ManufactureGeneratedKeyWait : NFCTouchTestStep_ManufactureGeneratedKeyWait (channel); break;
                case NFCTouchTestStep.ManufactureWriteSend        : NFCTouchTestStep_ManufactureWriteSend        (channel); break;
                case NFCTouchTestStep.ManufactureWriteWait        : NFCTouchTestStep_ManufactureWriteWait        (channel); break;
                case NFCTouchTestStep.ManufactureReadSend         : NFCTouchTestStep_ManufactureReadSend         (channel); break;
                case NFCTouchTestStep.ManufactureReadWait         : NFCTouchTestStep_ManufactureReadWait         (channel); break;
                ...
                case NFCTouchTestStep.NmWakeUpWait                : NFCTouchTestStep_NmWakeUpWait                (channel); break;
                ...
                case NFCTouchTestStep.ExtendedSessionWait         : NFCTouchTestStep_ExtendedSessionWait         (channel); break;
                case NFCTouchTestStep.PLightTurnOnSend            : NFCTouchTestStep_PLightTurnOnSend            (channel); break;
                case NFCTouchTestStep.PLightTurnOnWait            : NFCTouchTestStep_PLightTurnOnWait            (channel); break;
                case NFCTouchTestStep.PLightCurrentSend           : NFCTouchTestStep_PLightCurrentSend           (channel); break;
                case NFCTouchTestStep.PLightCurrentWait           : NFCTouchTestStep_PLightCurrentWait           (channel); break;
                case NFCTouchTestStep.PLightAmbientSend           : NFCTouchTestStep_PLightAmbientSend           (channel); break;
                case NFCTouchTestStep.PLightAmbientWait           : NFCTouchTestStep_PLightAmbientWait           (channel); break;
                case NFCTouchTestStep.PLightTurnOffSend           : NFCTouchTestStep_PLightTurnOffSend           (channel); break;
                case NFCTouchTestStep.PLightTurnOffWait           : NFCTouchTestStep_PLightTurnOffWait           (channel); break;
                ...
                case NFCTouchTestStep.TouchCan_LockCanWait        : NFCTouchTestStep_TouchCan_LockCanWait        (channel); break;
                ...
                case NFCTouchTestStep.NFC_CheckWait               : NFCTouchTestStep_NFC_CheckWait               (channel); break;
                ...
                case NFCTouchTestStep.XcpPrepareWait              : NFCTouchTestStep_XcpPrepareWait              (channel); break;
                case NFCTouchTestStep.XcpConnectSend              : NFCTouchTestStep_XcpConnectSend              (channel); break;
                case NFCTouchTestStep.XcpConnectWait              : NFCTouchTestStep_XcpConnectWait              (channel); break;
                case NFCTouchTestStep.SecuritySetMtaSend          : NFCTouchTestStep_SecuritySetMtaSend          (channel); break;
                case NFCTouchTestStep.SecuritySetMtaWait          : NFCTouchTestStep_SecuritySetMtaWait          (channel); break;
                case NFCTouchTestStep.SecurityUploadWait          : NFCTouchTestStep_SecurityUploadWait          (channel); break;
                ...
                case NFCTouchTestStep.DTCEraseWait                : NFCTouchTestStep_DTCEraseWait                (channel); break;
                case NFCTouchTestStep.HWVersionSend               : NFCTouchTestStep_HWVersionSend               (channel); break;
                case NFCTouchTestStep.HWVersionWait               : NFCTouchTestStep_HWVersionWait               (channel); break;
                case NFCTouchTestStep.SWVersionSend               : NFCTouchTestStep_SWVersionSend               (channel); break;
                case NFCTouchTestStep.SWVersionWait               : NFCTouchTestStep_SWVersionWait               (channel); break;
                case NFCTouchTestStep.PartNumberSend              : NFCTouchTestStep_PartNumberSend              (channel); break;
                case NFCTouchTestStep.PartNumberWait              : NFCTouchTestStep_PartNumberWait              (channel); break;
                case NFCTouchTestStep.BootloaderSend              : NFCTouchTestStep_BootloaderSend              (channel); break;
                case NFCTouchTestStep.BootloaderWait              : NFCTouchTestStep_BootloaderWait              (channel); break;
                case NFCTouchTestStep.BootDefaultSend             : NFCTouchTestStep_BootDefaultSend             (channel); break;
                case NFCTouchTestStep.BootDefaultWait             : NFCTouchTestStep_BootDefaultWait             (channel); break;
                case NFCTouchTestStep.BootWakeUpWait              : NFCTouchTestStep_BootWakeUpWait              (channel); break;
                case NFCTouchTestStep.BootExtendedSend            : NFCTouchTestStep_BootExtendedSend            (channel); break;
                case NFCTouchTestStep.BootExtendedWait            : NFCTouchTestStep_BootExtendedWait            (channel); break;
                case NFCTouchTestStep.RxsWinSend                  : NFCTouchTestStep_RxsWinSend                  (channel); break;
                case NFCTouchTestStep.RxsWinWait                  : NFCTouchTestStep_RxsWinWait                  (channel); break;
                case NFCTouchTestStep.SupplierCodeSend            : NFCTouchTestStep_SupplierCodeSend            (channel); break;
                case NFCTouchTestStep.SupplierCodeWait            : NFCTouchTestStep_SupplierCodeWait            (channel); break;
                ...
                case NFCTouchTestStep.SerialNumPrepareWait        : NFCTouchTestStep_SerialNumPrepareWait        (channel); break;
                case NFCTouchTestStep.SerialNumSeedkeySend        : NFCTouchTestStep_SerialNumSeedkeySend        (channel); break;
                case NFCTouchTestStep.SerialNumSeedkeyWait        : NFCTouchTestStep_SerialNumSeedkeyWait        (channel); break;
                ...
                case NFCTouchTestStep.SerialNumGeneratekeyWait    : NFCTouchTestStep_SerialNumGeneratekeyWait    (channel); break;
                case NFCTouchTestStep.SerialNumWriteSend          : NFCTouchTestStep_SerialNumWriteSend          (channel); break;
                case NFCTouchTestStep.SerialNumWriteWait          : NFCTouchTestStep_SerialNumWriteWait          (channel); break;
                case NFCTouchTestStep.SerialNumReadSend           : NFCTouchTestStep_SerialNumReadSend           (channel); break;
                case NFCTouchTestStep.SerialNumReadWait           : NFCTouchTestStep_SerialNumReadWait           (channel); break;
                ...
                case NFCTouchTestStep.CancelStart                 : NFCTouchTestStep_CancelStart                 (channel); break;
                case NFCTouchTestStep.CancelZTouchStart           : NFCTouchTestStep_CancelZTouchStart           (channel); break;
                case NFCTouchTestStep.CancelZTouchWait            : NFCTouchTestStep_CancelZTouchWait            (channel); break;
                case NFCTouchTestStep.CancelZCancelStart          : NFCTouchTestStep_CancelZCancelStart          (channel); break;
                case NFCTouchTestStep.CancelZCancelWait           : NFCTouchTestStep_CancelZCancelWait           (channel); break;
                case NFCTouchTestStep.CancelZNFCStart             : NFCTouchTestStep_CancelZNFCStart             (channel); break;
                case NFCTouchTestStep.CancelZNFCWait              : NFCTouchTestStep_CancelZNFCWait              (channel); break;
                case NFCTouchTestStep.CancelYHomeStart            : NFCTouchTestStep_CancelYHomeStart            (channel); break;
                case NFCTouchTestStep.CancelYHomeWait             : NFCTouchTestStep_CancelYHomeWait             (channel); break;
                case NFCTouchTestStep.CancelComplete              : NFCTouchTestStep_CancelComplete              (channel); break;
                default: break;
            }
        }
        ...
        private void NFCTouchTestStep_ShortTestWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                {
                    ...
                    SetTestStep(channel, NFCTouchTestStep.ShortTestStart);
                }
                else
                {
        ...
        private void NFCTouchTestStep_WakeUpWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(3000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Wake Up Timeout! Retry: [ {_retryCount[channel]} ]");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Wake Up Timeout! Retry: [ {_retryCount[channel]} ]");
                    SetTestStep(channel, NFCTouchTestStep.WakeUpSend);
                }
                else
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Wake Up Timeout Error!");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Wake Up Timeout Error!");
                    string message = $"제품으로부터 응답이 없습니다. 제품이 정상적으로 연결이 되어 있는지 확인하시고 다시 시도해 주세요.";
                    GSystem.MainFormMessageBox?.Invoke(message, "연결 오류", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                XLcanRxEvent receivedEvent = new XLcanRxEvent();
                if (ReceiveCan(channel, ref receivedEvent))
                {
                    GSystem.TraceMessage(GetRxEventString(receivedEvent).ToString());
                    uint rxCanID = GetCanID(receivedEvent.tagData.canRxOkMsg.canId);
        ...
        private void NFCTouchTestStep_ManufacturePrepareSend(int channel)
        {
            ...
            _overalResult[channel].Manufacture.Min = ProductSettings.TestItemSpecs.Manufacture.MinString;
            _overalResult[channel].Manufacture.Max = ProductSettings.TestItemSpecs.Manufacture.MaxString;
        ...
        private void NFCTouchTestStep_ManufacturePrepareWait(int channel)
        {
        ...
        private void NFCTouchTestStep_ManufactureSeedkeyWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_ManufactureGeneratedKeyWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_ManufactureWriteWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_ManufactureReadWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_DarkCurrentStart(int channel)
        {
            ...
            _overalResult[channel].DarkCurrent.Min = ProductSettings.TestItemSpecs.DarkCurrent.MinValue.ToString("F0");
            _overalResult[channel].DarkCurrent.Max = ProductSettings.TestItemSpecs.DarkCurrent.MaxValue.ToString("F0");
        ...
        private void NFCTouchTestStep_DarkCurrentComplete(int channel)
        {
            ...
            // 
            short minValue = 420;//(short)(testSpec.MinValue);
        ...
        private void NFCTouchTestStep_NmWakeUpWait(int channel)
        {
        ...
        private void NFCTouchTestStep_ExtendedSessionWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_PLightTurnOnSend(int channel)
        {
            ...
            _overalResult[channel].PLightTurnOn.Min = ProductSettings.TestItemSpecs.PLightTurnOn.MinValue.ToString("F0");
            _overalResult[channel].PLightTurnOn.Max = ProductSettings.TestItemSpecs.PLightTurnOn.MaxValue.ToString("F0");
        ...
        private void NFCTouchTestStep_PLightTurnOnWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_PLightCurrentSend(int channel)
        {
            ...
            _overalResult[channel].PLightCurrent.Min = ProductSettings.TestItemSpecs.PLightCurrent.MinValue.ToString("F0");
            _overalResult[channel].PLightCurrent.Max = ProductSettings.TestItemSpecs.PLightCurrent.MaxValue.ToString("F0");
            NextTestStep(channel);
            _tickStepTimeout[channel].Reset();
            _tickStepInterval[channel].Reset();
        }
        private void NFCTouchTestStep_PLightCurrentWait(int channel)
        {
        ...
        private void NFCTouchTestStep_PLightAmbientSend(int channel)
        {
            ...
            _overalResult[channel].PLightAmbient.Min = ProductSettings.TestItemSpecs.PLightAmbient.MinValue.ToString("F0");
            _overalResult[channel].PLightAmbient.Max = ProductSettings.TestItemSpecs.PLightAmbient.MaxValue.ToString("F0");
            NextTestStep(channel);
        }
        private void NFCTouchTestStep_PLightAmbientWait(int channel)
        {
        ...
        {
            // P-Light OFF 명령은 별도로 없고 P-Light ON 메시지 전송을 중지하면 OFF 된다.
            // P-Light ON message 중지
            _enablePLight[channel] = false;
            NextTestStep(channel);
            _tickStepTimeout[channel].Reset();
        }
        private void NFCTouchTestStep_PLightTurnOffWait(int channel)
        {
            // P-Light OFF는 확인하지 않는다.
            // P-Light OFF 확인
            if (_tickStepInterval[channel].LessThan(500))
                return;
            NextTestStep(channel);
        ...
        private void NFCTouchTestStep_TouchTestStart(int channel)
        {
            ...
            {
                if (GetTestStep(CH2) > NFCTouchTestStep.TouchTestStart &&
                    GetTestStep(CH2) < NFCTouchTestStep.MotionTouchZUpWait)
                    return;
            }
            else if (channel == GSystem.CH2)
            {
                if (GetTestStep(CH1) > NFCTouchTestStep.TouchTestStart &&
                    GetTestStep(CH1) < NFCTouchTestStep.MotionTouchZUpWait)
                    return;
            }
        ...
        private void NFCTouchTestStep_TouchCan_LockCanWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                // 에러 처리
                ...
                else
                {
                    ...
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Touch Lock State [ 0x{GSystem.TouchLockState[channel]:X02} ]");
                    ...
                    // 결과 판정
                    _overalResult[channel].LockCan.State = TestStates.Failed;
                    _overalResult[channel].LockCan.Value = $"0x{GSystem.TouchLockState[channel]:X02}";
            ...
            else
            {
                ...
                else
                {
                    if (_tickStepInterval[channel].MoreThan(500))
                    {
                        _tickStepInterval[channel].Reset();
                        Send_HardwireTest(channel, true);
                        GSystem.Logger.Info ($"[CH.{channel + 1}] Hardwire retry!");
                        GSystem.TraceMessage($"[CH.{channel + 1}] Hardwire retry!");
                    }
                }
            }
        }
        private void NFCTouchTestStep_TouchCap_LockCanWait(int channel)
        {
            ...
            if (_tickStepTimeout[channel].MoreThan(5000))
            {
                ...
                // 결과 판정
                _overalResult[channel].LockCan.State = TestStates.Failed;
                _overalResult[channel].LockCan.Value = $"0,0";
                _overalResult[channel].LockCan.Result = "Timeout";
                // 동작 상태 표시
                OnTestStepProgressChanged(channel, _overalResult[channel].LockCan);
                // Touch 상승
        ...
        private void NFCTouchTestStep_CancelCapacitanceStart(int channel)
        {
            if (channel == GSystem.CH1)
            {
                if (GetTestStep(CH2) > NFCTouchTestStep.CancelCapacitanceStart &&
                    GetTestStep(CH2) < NFCTouchTestStep.MotionCancelZDownWait)
                    return;
            }
            else if (channel == GSystem.CH2)
            {
                if (GetTestStep(CH1) > NFCTouchTestStep.CancelCapacitanceStart &&
                    GetTestStep(CH1) < NFCTouchTestStep.MotionCancelZDownWait)
                    return;
            }
            if (_tickStepInterval[channel].LessThan(100))
                return;
        ...
        private void NFCTouchTestStep_CancelCapacitanceWait(int channel)
        {
            ...
            if (_tickStepTimeout[channel].MoreThan(5000))
            {
                ...
                _overalResult[channel].Cancel.Value = $"0,0";
        ...
        {
            // *** NFC는 Z축이 완전히 하강하기 전에 확인 될 수 있다. 그래서 하강 확인은 하지 않고 다음 스텝으로 바로 넘어간다.
        ...
        private void NFCTouchTestStep_NFC_CheckWait(int channel)
        {
            // 1mm씩 하강일 때
            if (GSystem.MiPLC.GetNFC_Z_PositionStart(channel))
            {
            ...
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                ...
                else
                {
                    // 에러 처리
                    GSystem.NFC_State[channel] = 0;
                    GSystem.Logger.Info ($"[CH.{channel + 1}] NFC State [ 0x{GSystem.NFC_State[channel]:X02} ]");
                    ...
                    _overalResult[channel].NFC.Value = $"0x{GSystem.NFC_State[channel]:X02}";
        ...
        private void NFCTouchTestStep_XcpPrepareWait(int channel)
        {
            NextTestStep(channel);
            _retryCount[channel] = 0;
        }
        ...
        private void NFCTouchTestStep_XcpConnectWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                ...
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] XCP Connect Timeout Error!");
                    GSystem.TraceMessage($"[CH.{channel + 1}] XCP Connect Timeout Error!");
                    _isCancel[channel] = true;
                    SetTestStep(channel, NFCTouchTestStep.PowerOff);
                }
            }
                ...
                if (ReceiveCan(channel, ref receivedEvent))
                {
                    ...
                    if (rxCanID == GSystem.ProductSettings.XcpResID)
                    {
                        if (receivedEvent.tagData.canRxOkMsg.data[0] == 0xFF &&
                            receivedEvent.tagData.canRxOkMsg.data[2] == 0x40)
                        {
                            GSystem.Logger.Info (GetRxEventString(receivedEvent).ToString());
                            GSystem.TraceMessage(GetRxEventString(receivedEvent).ToString());
        ...
        private void NFCTouchTestStep_SecuritySetMtaWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                ...
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Security SetMTA Timeout Error!: [ {_retryCount[channel]} ]");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Security SetMTA Timeout Error!: [ {_retryCount[channel]} ]");
                    _isCancel[channel] = true;
                    SetTestStep(channel, NFCTouchTestStep.PowerOff);
                }
            }
        ...
        private void NFCTouchTestStep_SecurityUploadWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                ...
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Security Upload Timeout Error!");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Security Upload Timeout Error!");
                    _isCancel[channel] = true;
                    SetTestStep(channel, NFCTouchTestStep.PowerOff);
                }
            }
        ...
        private void NFCTouchTestStep_DTCEraseWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_HWVersionWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SWVersionWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_PartNumberWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_BootloaderWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(3000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_BootDefaultWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                ...
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Default Session Timeout Error!");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Default Session Timeout Error!");
                    _isCancel[channel] = true;
                    SetTestStep(channel, NFCTouchTestStep.PowerOff);
                }
            }
        ...
        private void NFCTouchTestStep_BootWakeUpWait(int channel)
        {
        ...
        private void NFCTouchTestStep_BootExtendedWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                ...
                {
                    GSystem.Logger.Info ($"[CH.{channel + 1}] Boot Extended Session Timeout Error!");
                    GSystem.TraceMessage($"[CH.{channel + 1}] Boot Extended Session Timeout Error!");
                    _isCancel[channel] = true;
                    SetTestStep(channel, NFCTouchTestStep.PowerOff);
                }
            }
        ...
        private void NFCTouchTestStep_RxsWinWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SupplierCodeWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SerialNumPrepareWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SerialNumSeedkeyWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SerialNumGeneratekeyWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SerialNumWriteWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_SerialNumReadWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(1000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
        ...
        private void NFCTouchTestStep_TestEndWait(int channel)
        {
            if (_tickStepTimeout[channel].MoreThan(2000))
            {
                if (++_retryCount[channel] < MaxRetryCount)
                {
                    ...
                    SetTestStep(channel, NFCTouchTestStep.TestEndStart);
                }
                else
                {
        ...
        private void NFCTouchTestStep_Complete(int channel)
        {
            ...
            else
            {
                ...
                lock (_lock)
                {
                    ...
                    GCsvFile dataAllFile = new GCsvFile();
                    if (dataAllFile.Open(fileName, filePath))
                    {
                        // 제목 저장
                    ...
                    // DATA_DELTA
                    filePath = $"{GSystem.SystemData.GeneralSettings.DataFolderDelta}\\{ProductSettings.ProductInfo.PartNo}\\{saveDate:yyyy}\\{saveDate:MM}";
                    ...
                    GCsvFile dataDeltaFile = new GCsvFile();
                    if (dataDeltaFile.Open(fileName, filePath))
                    {
                        // 제목 저장
                        // 채널, 시간, 일련번호, 차종, 작업자, 테스트(이름,측정값,결과)
                        StringBuilder sb = new StringBuilder();
                        if (bTitleWrite)
                        {
                            ...
                            sb.Append("Total Result");
                            sb.Append(Environment.NewLine);
                            dataDeltaFile.Write(sb.ToString());
                    ...
                    if (overalResult == TestStates.Pass)
                    {
                            ...
                            GSystem.ProductBarcode[channel] != GSystem.ProductSettings.MasterSampleCh1.MasterBarcode5)
                        {
                            ...
                            if (GSystem.ProductSettings.ProductInfo.UseLabelPrint)
                            {
                                ...
                                string item1 = GSystem.ProductSettings.LabelPrint.Payload.Item1;
                                string item2 = GSystem.ProductSettings.LabelPrint.Payload.Item2;
                                string item3 = GSystem.ProductSettings.LabelPrint.Payload.Item3;
                                string item4 = GSystem.ProductSettings.LabelPrint.Payload.Item4;
                                string item5 = GSystem.ProductSettings.LabelPrint.Payload.Item5;
        ...
        private void NFCTouchTestStep_CancelStart(int channel)
        {
            _tickStepElapse[channel].Reset();
            ...
            SetTestStep(channel, NFCTouchTestStep.CancelZTouchStart);
            _tickStepTimeout[channel].Reset();
            _tickStepInterval[channel].Reset();
        }
        private void NFCTouchTestStep_CancelZTouchStart(int channel)
        {
            ...
            if (GSystem.MiPLC.GetState1(channel, (int)PLC_State1_Bit.TouchZ))
                GSystem.MiPLC.SetTouchZUpStart(channel, true);
            SetTestStep(channel, NFCTouchTestStep.CancelZTouchWait);
        }
        private void NFCTouchTestStep_CancelZTouchWait(int channel)
        {
            // TOUCH 상승
            if (GSystem.MiPLC.GetTouchZUpStart(channel))
            {
            ...
            SetTestStep(channel, NFCTouchTestStep.CancelZCancelStart);
            _tickStepInterval[channel].Reset();
        }
        private void NFCTouchTestStep_CancelZCancelStart(int channel)
        {
            // CANCEL 하강
            if (GSystem.MiPLC.GetState1(channel, (int)PLC_State1_Bit.CancelZ))
                GSystem.MiPLC.SetCancelZDownStart(channel, true);
            SetTestStep(channel, NFCTouchTestStep.CancelZCancelWait);
        }
        private void NFCTouchTestStep_CancelZCancelWait(int channel)
        {
            // CANCEL 하강
            if (GSystem.MiPLC.GetCancelZDownStart(channel))
            {
            ...
            SetTestStep(channel, NFCTouchTestStep.CancelZNFCStart);
        }
        private void NFCTouchTestStep_CancelZNFCStart(int channel)
        {
            // NFC 상승
            if (GSystem.MiPLC.GetState1(channel, (int)PLC_State1_Bit.NFC_Z))
                GSystem.MiPLC.SetNFCZUpStart(channel, true);
            SetTestStep(channel, NFCTouchTestStep.CancelZNFCWait);
        }
        private void NFCTouchTestStep_CancelZNFCWait(int channel)
        {
            // NFC 상승
            if (GSystem.MiPLC.GetCancelZDownStart(channel))
            {
            ...
            SetTestStep(channel, NFCTouchTestStep.CancelComplete);
        }
        private void NFCTouchTestStep_CancelYHomeStart(int channel)
        {
            if (_tickStepInterval[channel].LessThan(100))
                return;
            ...
            SetTestStep(channel, NFCTouchTestStep.CancelYHomeWait);
        }
        private void NFCTouchTestStep_CancelYHomeWait(int channel)
        {
            if (GSystem.MiPLC.GetMoveLoadStart(channel) || !GSystem.MiPLC.GetUnloadingStart(channel))
            {
                if (!GSystem.MiPLC.GetMoveLoadComplete(channel) || !GSystem.MiPLC.GetUnloadingComplete(channel))
        ...
        private void NFCTouchTestStep_CancelComplete(int channel)
        {
            GSystem.MiPLC.SetZInterlockIgnore(channel, false);
