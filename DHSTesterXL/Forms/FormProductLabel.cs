...
namespace DHSTesterXL
{
    ...
    public partial class FormProduct : Form
    {
        ...
        // ───────────────────── Label Grid ─────────────────────
        private const string ColumnSequence = "Seq";
        private const string ColumnField = "Field";
        private const string ColumnData = "Data";
        private const string ColumnXMm = "Xmm";
        private const string ColumnYMm = "Ymm";
        private const string ColumnFontMm = "Fontmm";
        private const string ColumnScaleX = "Xscale";   // 가로 비율
        private const string ColumnScaleY = "Yscale";   // 세로 비율

        // 표시 체크박스(미리보기/인쇄)
        private const string ColumnShowPreview = "미리보기";
        private const string ColumnShowPrint = "인쇄";
