...
namespace DHSTesterXL
{
    ...
    public class MitsubishiPLC
    {
        ...
        public bool GetAutoTestStart(int channel)
        {
            ...
            if (channel == 0)
            {
                if ((GSystem.MiPLC.Ch1_R_Status1 & GDefines.BIT16[bitIndex]) == GDefines.BIT16[bitIndex])
                    return true;
            }
            else
            {
                if ((GSystem.MiPLC.Ch2_R_Status1 & GDefines.BIT16[bitIndex]) == GDefines.BIT16[bitIndex])
                    return true;
            }
            return false;
        }
        ...
        public bool GetTouchZDownComplete(int channel)
        {
            ...
            if (channel == 0)
            {
                if ((GSystem.MiPLC.Ch1_R_Status2 & GDefines.BIT16[bitIndex]) == GDefines.BIT16[bitIndex])
                    return true;
            }
            else
            {
                if ((GSystem.MiPLC.Ch2_R_Status2 & GDefines.BIT16[bitIndex]) == GDefines.BIT16[bitIndex])
                    return true;
            }
            return false;
        }
        ...
        public bool GetUnclampStart(int channel)
        {
            int bitIndex = 13;
            if (channel == 0)
            {
        ...
        public void SetUnclampStart(int channel, bool state)
        {
            int bitIndex = 13;
            if (channel == 0)
            {
        ...
        public bool GetUnclampComplete(int channel)
        {
            int bitIndex = 14;
            if (channel == 0)
            {
